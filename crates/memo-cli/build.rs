...
//!
//! Walked rather than listed. `memo configs` has to carry every file in `config/`, and a hand-
...
//! a `.rs` file would put a harness's name in memo's Rust, and the gate is right to refuse that
