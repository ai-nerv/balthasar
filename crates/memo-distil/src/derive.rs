...
//! `MEMO_NO_EMBED=1` intact, and leaves semantic with an exact-overlap floor rather than
//! nothing.
//!
...
use memo_model::{Derivation, Memory, MemoryId, Relation, Timestamp, View};
...
/// occurred and when memo was told about it are different questions and only the first orders
...
mod tests {
    use super::*;
    use memo_model::{Body, NoteKind, ScopeId, Temporal, Tier};
