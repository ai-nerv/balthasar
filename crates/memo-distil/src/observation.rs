//! What a harness's transcript looks like once memo has it.
//!
//! memo defines this shape and a harness converts to it, in Lua. That is the whole of the
