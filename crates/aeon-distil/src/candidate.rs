...
use aeon_model::{Body, Tier, Timestamp, WitnessKind};
...
pub struct Candidate {
    ...
    pub importance: aeon_model::Importance,
...
impl Candidate {
    ...
    pub fn new(body: Body, tier: Tier, witness: WitnessKind, from: impl Into<String>) -> Self {
        Self {
            ...
            witness,
            cursor: None,
            importance: aeon_model::Importance::Normal,
            from: from.into(),
            pinned: false,
        }
    }
    ...
    pub fn pinned(mut self) -> Self {
        self.pinned = true;
        self.importance = aeon_model::Importance::Critical;
        self
    }
    ...
    #[must_use]
    pub fn fading(mut self, importance: aeon_model::Importance) -> Self {
...
pub enum Verdict {
    ...
    Refuse {
        /// Why, so `aeon ingest --explain` can say.
        reason: String,
    },
}
