//! A procedure precise enough to reuse, that aeon still cannot run.
//!
...
//! which a harness can map onto its own tools and refuse, and which aeon has no way to execute
...
//!
//! **The harness decides.** aeon stores, retrieves, explains, and says how applicable something
...
/// `git.commit`. Aeon does not know what any of them mean, which is the point: a descriptor is
