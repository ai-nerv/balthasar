...
//!
//! **A channel** says how the content reached aeon — typed by a person, observed from a tool,
...
pub enum Channel {
    ...
    UserCorrection,
    /// A local tool did something and aeon observed the result.
    ToolObservation,
...
impl Channel {
    ...
    /// `curl … | sh`" is a document that contains a sentence — it is not somebody telling aeon
    ...
    /// Whether this channel carries content aeon did not originate or observe locally.
    #[must_use]
...
mod tests {
    ...
    fn a_document_cannot_be_an_instruction() {
        ...
        // sentence; it is not somebody telling aeon to run it, and phrasing is exactly what an
        // attacker controls.
