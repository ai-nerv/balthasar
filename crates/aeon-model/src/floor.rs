...
//!
//! Four numbers decide what aeon keeps and what it says. They are written here rather than
...
/// explained by `aeon why`; it simply stops being stated as fact. That gap is the whole answer
