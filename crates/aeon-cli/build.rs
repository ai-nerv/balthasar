...
//!
//! Walked rather than listed. `aeon configs` has to carry every file in `config/`, and a hand-
...
//! a `.rs` file would put a harness's name in aeon's Rust, and the gate is right to refuse that
