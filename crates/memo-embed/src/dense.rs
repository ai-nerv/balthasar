...
//! Deciding two claims are one claim is [`memo_distil::same_claim`]'s job and stays there,
//! whatever embedder is loaded.
//!
//! # Why it is behind a feature
//!
//! Weights are 127 MB and the tensor library is a large dependency. memo's default build has
