...
use balthasar_host::{Answering, Door, answer, answer_with};
...
impl Harness {
    fn new() -> Self {
        Self {
            ...
            scrollback: balthasar_store::Transcript::ephemeral().expect("scrollback"),
        }
    }
...
fn the_run_says_what_model_it_talks_to_and_the_plan_believes_it() {
    // balthasar does the compacting, so balthasar has to know the size of the thing it compacts for. A
