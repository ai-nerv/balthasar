...
use balthasar_model::{Derivation, Family, MemoryId, Relation, Timestamp, View};
use rusqlite::params;
...
mod tests {
    ...
    fn an_edge_never_touches_the_memories_it_connects() {
        ...
        let mut store = Store::ephemeral().expect("store");
        let held = balthasar_model::Memory::new(
            crate::mint(NOW),
            balthasar_model::Tier::Fact,
            balthasar_model::ScopeId::new("/w/p"),
            balthasar_model::Body::note("a claim", balthasar_model::NoteKind::Claim),
            NOW,
        );
        ...
        store
            .remember(
                ...
                balthasar_model::Witness::new(
                    ...
                    balthasar_model::SessionId::new("01RUN"),
                    balthasar_model::ScopeId::new("/w/p"),
                    NOW,
                ),
                NOW,
