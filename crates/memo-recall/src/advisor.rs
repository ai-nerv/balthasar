...
use crate::Policy;
use memo_model::{Presentation, Tier};
...
impl Forbidden {
    ...
    pub fn because(self) -> &'static str {
        match self {
            ...
            Self::Execute => "memo describes procedures and never runs them",
...
mod tests {
    ...
    fn a_model_may_weaken_a_presentation_and_never_strengthen_one() {
        ...
        // influence what memo states as true.
        assert_eq!(
    ...
    fn no_proposal_can_express_a_forbidden_thing() {
        ...
        let every = [
            ...
            Proposal::Boundary(4),
            Proposal::Related(memo_model::View::SameEntity),
