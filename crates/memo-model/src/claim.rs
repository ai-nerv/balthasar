...
//! person or a model.
//!
//! So the suite found memo asserting both *"we deploy to heroku"* and *"we deploy to fly.io"*
...
/// second fact — which is how the suite found memo asserting both answers at once.
const OPENERS: &[&str] = &[
    "no",
    "nope",
    "actually",
