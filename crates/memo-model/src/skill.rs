//! A procedure precise enough to reuse, that memo still cannot run.
//!
...
//! which a harness can map onto its own tools and refuse, and which memo has no way to execute
...
//!
//! **The harness decides.** memo stores, retrieves, explains, and says how applicable something
...
/// `git.commit`. Memo does not know what any of them mean, which is the point: a descriptor is
