...
//!
//! Four numbers decide what memo keeps and what it says. They are written here rather than
...
/// explained by `memo why`; it simply stops being stated as fact. That gap is the whole answer
