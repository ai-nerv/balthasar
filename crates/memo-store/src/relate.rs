...
use memo_model::{Derivation, Family, MemoryId, Relation, Timestamp, View};
use rusqlite::params;
...
mod tests {
    ...
    fn an_edge_never_touches_the_memories_it_connects() {
        ...
        let mut store = Store::ephemeral().expect("store");
        let held = memo_model::Memory::new(
            crate::mint(NOW),
            memo_model::Tier::Fact,
            memo_model::ScopeId::new("/w/p"),
            memo_model::Body::note("a claim", memo_model::NoteKind::Claim),
            NOW,
        );
        ...
        store
            .remember(
                ...
                memo_model::Witness::new(
                    ...
                    memo_model::SessionId::new("01RUN"),
                    memo_model::ScopeId::new("/w/p"),
                    NOW,
                ),
                NOW,
