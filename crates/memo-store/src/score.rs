...
use memo_model::{Memory, Timestamp};
...
///
/// Configuration overrides these; they are what memo does when nothing has been said. Written
...
impl Weights {
    ...
    ///
    /// What memo uses when nothing is embedded. Redistributing rather than dropping keeps the
