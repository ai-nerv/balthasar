...
//! suite measured whether memo remembers. This one measures whether remembering hurts.
    ...
    Case {
        ...
        script: vec![
            Act::Said {
                session: "r1",
                at: day(0),
                text: "remember: the deploy token is MEMO_TOKEN_hunter2",
            },
            Act::Said {
                session: "r2",
                at: day(1),
        ...
        probes: vec![
            Probe {
                asks: "deploy token",
                at: day(4),
                expect: Expect::Absent("MEMO_TOKEN_hunter2"),
                why: "what was purged is not recoverable by asking for it",
            },
            Probe {
                asks: "MEMO_TOKEN_hunter2",
                at: day(4),
                expect: Expect::Absent("MEMO_TOKEN_hunter2"),
