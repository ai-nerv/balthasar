...
use memo_ipc::Peer;
use memo_model::{ScopeId, WitnessKind};
...
mod tests {
    ...
    fn a_peers_write_is_still_worth_something() {
        ...
        assert!(!WitnessKind::Manual.crosses_alone(memo_model::floor::PROMOTE));
    }
    ...
    fn every_write_by_a_peer_names_the_process() {
        // `memo why` has to be able to say which process believes something.
