...
//! `MAGI_BALTHASAR_NO_EMBED=1` intact, and leaves semantic with an exact-overlap floor rather than
//! nothing.
//!
...
use balthasar_model::{Derivation, Memory, MemoryId, Relation, Timestamp, View};
...
/// occurred and when balthasar was told about it are different questions and only the first orders
...
mod tests {
    use super::*;
    use balthasar_model::{Body, NoteKind, ScopeId, Temporal, Tier};
