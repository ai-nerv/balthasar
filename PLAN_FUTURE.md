| **F5** | built | write channels and trust domains; confidence counts sources, not repetitions; the imperative downgrade; quarantine as a gate; ten deterministic attacks at a zero success rate; purge closure over every derived table, with adversarial recovery tests |
